-- Seed data for SubGuard SaaS Subscription Optimizer (Rupees Edition)
-- Sets up a default user and active subscriptions with historical billing logs

USE smartspend;

-- 1. Insert Default User (username: john_doe, email: john@example.com, password: password123)
...
-- 2. Insert Active Subscriptions (Rupee Values)
...
-- 3. Insert Billing History (Rupee Values)
...
(19, 1, 'Netflix Premium', 649.00, '2026-05-28'), -- Anomaly: Price hiked from 599 to 649
...
(29, 1, 'Slack Pro', 1500.00, '2026-06-05'), -- Anomaly: double billing (charged 1500 instead of 750)
...
-- 4. Insert Budgets for SaaS Spend Categories (Rupee Limits)
